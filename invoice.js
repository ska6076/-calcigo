(function () {
  ...
  function recalculateTotals() {
    ...
    const grandTotal =
      subTotal + transportation + fitting + cgstAmount + sgstAmount;
    ...
    try {
      if (typeof localStorage !== "undefined") {
        ...
        if (lastValue === null) {
          ...
          currentNumber =
            isNaN(parsed) || parsed < START_ESTIMATE_NUMBER
  ...
  // Recalculate totals when transportation or fitting cost changes
